...
/**
 * balance_f - Measures balance_fance factor of a AVL
 * @tree: tree to go through
 * Return: balance_fanced factor
 */
void balance_f(avl_t **tree)
{
	int bval;
...
/**
 *remove_node_type - function that removes a node depending of its children
 *@root: node to remove
